...
<header
	id="masthead"
	class="at-top"
	class:home={$page.url.pathname === '/fr' || $page.url.pathname === '/en'}
>
	...
	<div class="menusContainer menuOverlay" class:menuIsVisible>
		<div class="container">
			<div class="logo_group">
				<Logo on:logoClicked={() => (menuIsVisible = false)} />

				<button on:click={() => (menuIsVisible = false)} class="btn_clean menus_close_btn">
					<IconClose />
				</button>
			</div>

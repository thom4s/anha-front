<script>
    ...
    const handleMouseMove = (event) => {
        // if (event.target.classList.contains('clickable')) fullScreen = true;
        // else fullScreen = false;

        // if (event.target.classList.contains('hoverTarget') && !event.target.classList.contains('hoverTarget')) simple = true;
        // else fullScreen = simple;
...
<div class="custom-cursor">
    ...
    <!-- {/if} -->
    <!-- {:else}
        <div class="simple-cursor">Voir</div>
    {/if} -->
</div>

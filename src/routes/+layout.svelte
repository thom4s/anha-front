...
{#if isLoading}
	<div class="loader" in:fade={{ duration: 200 }} out:fade={{ duration: 200 }}></div>
{/if}

<main class="main">
	{#key data.pathname}
		<div class="template-outer" in:fade={{ duration: 300, delay: 0 }} out:fade={{ duration: 300 }}>
			<slot />
		</div>
	{/key}
</main>
